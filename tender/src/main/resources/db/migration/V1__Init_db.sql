...
insert into hibernate_sequence values ( 1 );
 ...
 create table orders (id bigint not null, date date, number varchar(255), primary key (id)) engine=MyISAM;
 ...
 create table tender (id bigint not null, date date, filename varchar(255), name varchar(255), number varchar(255), payment_factor varchar(255), price_factor varchar(255), stage varchar(255), oreder_id bigint, primary key (id)) engine=MyISAM;
